...
/* harmony export */ });
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs/operators */ 8636);
...
class AppComponent {
  ...
  */
  ...
  getConfig() {
    return this.httpClient.get('/api').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_0__.tap)( // Log the result or error
    {
      next: data => console.log(data),
      error: error => console.log("ERRROR" + error)
    }));
  }
...
AppComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
  ...
  template: function AppComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipeBind1"](2, 1, ctx.getConfig()), "\n");
    }
  },
